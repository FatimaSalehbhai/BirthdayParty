...
var canvas = document.getElementById("canvas"),
    ...
    keyword = "HAPPY BIRTHDAY PRANJU",
		imageData,
		density =2,
		mouse = {},
		hovered = false,
		//colors = ["237, 252, 17", "15, 245, 46", "15, 237,  245", "245, 15, 15", "245, 15, 214"],
		colors = ["232, 124, 117", "184, 149, 199", "246, 148,  32", "137, 197, 7", "23, 152, 193"],
		minDist = 30,
		bounceFactor = 5;
